...
**Claude Desktop** appears directly below Codex. It uses the app's official third-party gateway settings and filters the shared library to Claude models, preserving your library and other agents' choices. Quit an existing Claude Desktop instance before opening the prepared configuration. This integration does not provide a second independent Desktop instance or a project-folder launch argument. See [Claude Desktop setup, model compatibility and restoration](claude-desktop.md).
