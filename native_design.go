	...
	return nativeSurface(gtx, nativeColor(0x202720), 0, func(gtx layout.Context) layout.Dimensions {
		return layout.Inset{Top: 32, Bottom: 25, Left: 22, Right: 22}.Layout(gtx, func(gtx layout.Context) layout.Dimensions {
			return layout.Flex{Axis: layout.Vertical}.Layout(gtx,
				layout.Rigid(u.column(u.textStyle(24, "Kilo Local", nativeColor(0xf0f4e8), font.SemiBold), u.textStyle(9, "YOUR TEAM. YOUR TOOLS.", nativeColor(0x9ba58f), font.Medium))),
				...
				layout.Rigid(layout.Spacer{Height: 32}.Layout), layout.Rigid(u.textStyle(10, "KILO LOCAL   /   v"+version, nativeColor(0x839178), font.Normal)),
			)
		})
	})
}
...
func (u *nativeUI) pageTop(gtx layout.Context) layout.Dimensions {
	titles := map[string][2]string{"connection": {"Connect your workspace", "Conecta tu espacio de trabajo"}, "clients": {"Make it your own", "Elige tus herramientas"}, "activity": {"Your session, in detail", "Tu sesión, al detalle"}}
	...
	return layout.Flex{Axis: layout.Horizontal, Alignment: layout.Middle}.Layout(gtx,
		layout.Flexed(1, u.column(u.eyebrow(u.tr("Local workspace", "Espacio local")), u.textStyle(29, u.tr(title[0], title[1]), nativeColor(0x252b28), font.SemiBold), u.note(u.tr(description[0], description[1])))),
	...
	children = append(children, layout.Flexed(1, func(gtx layout.Context) layout.Dimensions {
		...
		return layout.Inset{Top: 22, Bottom: 18, Left: padding, Right: padding}.Layout(gtx, func(gtx layout.Context) layout.Dimensions {
			return layout.Flex{Axis: layout.Vertical}.Layout(gtx,
				...
				layout.Rigid(layout.Spacer{Height: 28}.Layout), layout.Rigid(u.pageTop), layout.Rigid(layout.Spacer{Height: 24}.Layout),
				layout.Rigid(func(gtx layout.Context) layout.Dimensions {
					if u.notice == "" {
						return layout.Dimensions{}
					}
